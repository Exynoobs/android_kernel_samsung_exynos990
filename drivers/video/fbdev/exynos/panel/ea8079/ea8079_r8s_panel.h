...
static u8 r8s_brt_table[EA8079_TOTAL_STEP][2] = {
	{0x00, 0x03}, {0x00, 0x06}, {0x00, 0x0A}, {0x00, 0x0D}, {0x00, 0x11}, {0x00, 0x14}, {0x00, 0x18}, {0x00, 0x1B}, {0x00, 0x1F}, {0x00, 0x22},
	{0x00, 0x26}, {0x00, 0x29}, {0x00, 0x2D}, {0x00, 0x30}, {0x00, 0x34}, {0x00, 0x37}, {0x00, 0x3B}, {0x00, 0x3E}, {0x00, 0x42}, {0x00, 0x45},
	{0x00, 0x49}, {0x00, 0x4C}, {0x00, 0x4F}, {0x00, 0x53}, {0x00, 0x56}, {0x00, 0x5A}, {0x00, 0x5D}, {0x00, 0x61}, {0x00, 0x64}, {0x00, 0x68},
	{0x00, 0x6B}, {0x00, 0x6F}, {0x00, 0x72}, {0x00, 0x76}, {0x00, 0x79}, {0x00, 0x7D}, {0x00, 0x80}, {0x00, 0x84}, {0x00, 0x87}, {0x00, 0x8B},
	{0x00, 0x8E}, {0x00, 0x92}, {0x00, 0x95}, {0x00, 0x98}, {0x00, 0x9C}, {0x00, 0x9F}, {0x00, 0xA3}, {0x00, 0xA6}, {0x00, 0xAA}, {0x00, 0xAD},
	{0x00, 0xB1}, {0x00, 0xB4}, {0x00, 0xB8}, {0x00, 0xBB}, {0x00, 0xBF}, {0x00, 0xC2}, {0x00, 0xC6}, {0x00, 0xC9}, {0x00, 0xCD}, {0x00, 0xD0},
	{0x00, 0xD4}, {0x00, 0xD7}, {0x00, 0xDB}, {0x00, 0xDE}, {0x00, 0xE1}, {0x00, 0xE5}, {0x00, 0xE8}, {0x00, 0xEC}, {0x00, 0xEF}, {0x00, 0xF3},
	{0x00, 0xF6}, {0x00, 0xFA}, {0x00, 0xFD}, {0x01, 0x01}, {0x01, 0x04}, {0x01, 0x08}, {0x01, 0x0B}, {0x01, 0x0F}, {0x01, 0x12}, {0x01, 0x16},
	{0x01, 0x19}, {0x01, 0x1D}, {0x01, 0x20}, {0x01, 0x24}, {0x01, 0x27}, {0x01, 0x2B}, {0x01, 0x2E}, {0x01, 0x31}, {0x01, 0x35}, {0x01, 0x38},
	{0x01, 0x3C}, {0x01, 0x3F}, {0x01, 0x43}, {0x01, 0x46}, {0x01, 0x4A}, {0x01, 0x4D}, {0x01, 0x51}, {0x01, 0x54}, {0x01, 0x58}, {0x01, 0x5B},
	{0x01, 0x5F}, {0x01, 0x62}, {0x01, 0x66}, {0x01, 0x69}, {0x01, 0x6D}, {0x01, 0x70}, {0x01, 0x74}, {0x01, 0x77}, {0x01, 0x7A}, {0x01, 0x7E},
	{0x01, 0x81}, {0x01, 0x85}, {0x01, 0x88}, {0x01, 0x8C}, {0x01, 0x8F}, {0x01, 0x93}, {0x01, 0x96}, {0x01, 0x9A}, {0x01, 0x9D}, {0x01, 0xA1},
	{0x01, 0xA4}, {0x01, 0xA8}, {0x01, 0xAB}, {0x01, 0xAF}, {0x01, 0xB2}, {0x01, 0xB6}, {0x01, 0xB9}, {0x01, 0xBD}, {0x01, 0xC0}, {0x01, 0xC5},
	{0x01, 0xC9}, {0x01, 0xCE}, {0x01, 0xD2}, {0x01, 0xD7}, {0x01, 0xDB}, {0x01, 0xE0}, {0x01, 0xE4}, {0x01, 0xE9}, {0x01, 0xED}, {0x01, 0xF2},
	{0x01, 0xF6}, {0x01, 0xFB}, {0x01, 0xFF}, {0x02, 0x04}, {0x02, 0x08}, {0x02, 0x0D}, {0x02, 0x11}, {0x02, 0x16}, {0x02, 0x1B}, {0x02, 0x1F},
	{0x02, 0x24}, {0x02, 0x28}, {0x02, 0x2D}, {0x02, 0x31}, {0x02, 0x36}, {0x02, 0x3A}, {0x02, 0x3F}, {0x02, 0x43}, {0x02, 0x48}, {0x02, 0x4C},
	{0x02, 0x51}, {0x02, 0x55}, {0x02, 0x5A}, {0x02, 0x5E}, {0x02, 0x63}, {0x02, 0x67}, {0x02, 0x6C}, {0x02, 0x71}, {0x02, 0x75}, {0x02, 0x7A},
	{0x02, 0x7E}, {0x02, 0x83}, {0x02, 0x87}, {0x02, 0x8C}, {0x02, 0x90}, {0x02, 0x95}, {0x02, 0x99}, {0x02, 0x9E}, {0x02, 0xA2}, {0x02, 0xA7},
	{0x02, 0xAB}, {0x02, 0xB0}, {0x02, 0xB4}, {0x02, 0xB9}, {0x02, 0xBE}, {0x02, 0xC2}, {0x02, 0xC7}, {0x02, 0xCB}, {0x02, 0xD0}, {0x02, 0xD4},
	{0x02, 0xD9}, {0x02, 0xDD}, {0x02, 0xE2}, {0x02, 0xE6}, {0x02, 0xEB}, {0x02, 0xEF}, {0x02, 0xF4}, {0x02, 0xF8}, {0x02, 0xFD}, {0x03, 0x01},
	{0x03, 0x06}, {0x03, 0x0A}, {0x03, 0x0F}, {0x03, 0x14}, {0x03, 0x18}, {0x03, 0x1D}, {0x03, 0x21}, {0x03, 0x26}, {0x03, 0x2A}, {0x03, 0x2F},
	{0x03, 0x33}, {0x03, 0x38}, {0x03, 0x3C}, {0x03, 0x41}, {0x03, 0x45}, {0x03, 0x4A}, {0x03, 0x4E}, {0x03, 0x53}, {0x03, 0x57}, {0x03, 0x5C},
	{0x03, 0x61}, {0x03, 0x65}, {0x03, 0x6A}, {0x03, 0x6E}, {0x03, 0x73}, {0x03, 0x77}, {0x03, 0x7C}, {0x03, 0x80}, {0x03, 0x85}, {0x03, 0x89},
	{0x03, 0x8E}, {0x03, 0x92}, {0x03, 0x97}, {0x03, 0x9B}, {0x03, 0xA0}, {0x03, 0xA4}, {0x03, 0xA9}, {0x03, 0xAD}, {0x03, 0xB2}, {0x03, 0xB7},
	{0x03, 0xBB}, {0x03, 0xC0}, {0x03, 0xC4}, {0x03, 0xC9}, {0x03, 0xCD}, {0x03, 0xD2}, {0x03, 0xD6}, {0x03, 0xDB}, {0x03, 0xDF}, {0x03, 0xE4},
	{0x03, 0xE8}, {0x03, 0xED}, {0x03, 0xF1}, {0x03, 0xF6}, {0x03, 0xFA}, {0x03, 0xFF}, {0x00, 0x00}, {0x00, 0x03}, {0x00, 0x05}, {0x00, 0x08},
